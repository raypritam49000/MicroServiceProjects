...
import com.api.gateway.dto.AuthResponse;
import com.api.gateway.dto.LoginRequest;
import com.api.gateway.entity.User;
import com.api.gateway.service.ILoginService;
...
public class LoginController {
    ...
    public ResponseEntity<User> registerUser(@RequestBody User user){
      return  new ResponseEntity<User>(iLoginService.saveUser(user),HttpStatus.CREATED);
    }
